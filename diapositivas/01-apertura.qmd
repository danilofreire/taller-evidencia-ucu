...
`r fa('book-open')` Investigación: inferencia causal, métodos experimentales y cuasi-experimentales (RDD, dif-en-dif, control sintético), evaluación de políticas públicas
:::
:::
::::
...
Si somos muchos y el tiempo aprieta, lo retomamos en el taller de la tarde, donde cada quien arma su propio diseño
:::
:::
...
Los dos primeros hechos son las dos preguntas del día: sin presupuesto, [¿de dónde sacás un contrafactual creíble?]{.alert} (mañana); base delgada, [¿cuándo un resultado se vuelve evidencia?]{.alert} (tarde)
:::
:::
...
|------|--------|:--------:|
| 9:00 | [Apertura]{.alert}: el problema del contrafactual | 30 min |
| 9:30 | [Experimentos]{.alert}: aleatorización y sesgo de selección | 75 min |
| 10:45 | Café | 15 min |
| 11:00 | [Regresión discontinua]{.alert}: el RDD de Brasil | 75 min |
| 12:15 | Cierre de la mañana y discusión | 15 min |
| 13:30 | [Diferencias en diferencias]{.alert} y control sintético | 45 min |
| 14:15 | [Acumulación]{.alert}: meta-análisis y replicación | 60 min |
| 15:15 | Cierre | 15 min |

:::{style="margin-top: 12px; border-left: 4px solid #2d4563; padding: 6px 18px; font-size: 20px;"}
El [tamaño de la legislatura]{.alert} vuelve dos veces: como RDD a la mañana y dentro de un meta-análisis a la tarde
:::
:::
...
- Los materiales están en [la página del taller](https://danilofreire.github.io/taller-evidencia-ucu/), y hacemos una pausa de café a las 10:45
