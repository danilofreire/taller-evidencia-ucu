...
subtitle: "Parte 1: el problema del contrafactual"
author:
  - name: Danilo Freire
...
## Hay mucha investigación buena en la región

:::{style="margin-top: 10px; font-size: 22px;"}
:::{.columns}
:::{.column width=50%}
[Sorteos y umbrales]{.alert}
...
- El [patrullaje en puntos calientes]{.alert} en Bogotá dio efectos modestos que casi no sobrevivieron a la escala ([RCT]{.alert}; [Blattman et al., 2021](https://doi.org/10.1093/jeea/jvab002))
...
:::{.column width=50%}
[Trayectorias en el tiempo]{.alert}
...
:::{style="margin-top: 6px; text-align: center; font-size: 23px; color: #555;"}
Hay varios más en las [referencias](#sec:referencias) del final
:::
:::
...
:::{style="margin-top: 30px; border-left: 4px solid #2d4563; padding: 6px 18px; font-size: 22px;"}
...
paquetes <- c("tidyverse", "estimatr", "DeclareDesign", "fabricatr",
